...
/**
 * @extends AbstractCrudController<DailyConsumption>
 */
#[AdminCrud(routePath: '/yunpian/daily-consumption', routeName: 'yunpian_daily_consumption')]
final class DailyConsumptionCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        ;
        yield ArrayField::new('items', '消费明细')
            ->onlyOnDetail()
